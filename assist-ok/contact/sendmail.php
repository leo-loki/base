...
$body .= "\r\n".
$site_name.'へお問合せいただき誠に有り難うございます。' . "\r\n".
'下記の内容で承りました。' . "\r\n".
'後ほど担当者からご連絡させていただきますので、もうしばらくお待ちください。' . "\r\n".
'お問合せへのご対応は営業日（平日）のみとなります。' . "\r\n".
'土・日・祝日の場合は翌営業日となりますので予めご了承ください。' . "\r\n".
'平日１日を過ぎましても担当者からの連絡がない場合は、' . "\r\n".
'お手数ですが下記のメールまたは電話番号まで直接ご連絡ください。' . "\r\n".
"\r\n".
'今後とも宜しくお願いいたします。' . "\r\n".
"\r\n";
