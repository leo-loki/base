...
<p><input type="text" id="name" name="name" size="25" value="" autofocus placeholder="（例）鈴木花子" class="tipped" title="（例）鈴木一郎" style="ime-mode: active;"></p>

<h4>フリガナ<span class="ak">*</span></h4>
<p><input type="text" id="kana" name="kana" size="30" value="" placeholder="（例）スズキハナコ" class="tipped" title="空白は入れないでください" style="ime-mode: active;"></p>
...
<h4>ご住所<span class="ak">*</span></h4>
<p>
<span class="p-country-name" style="display:none;">Japan</span>
〒<input type="text" class="p-postal-code" id="zip1" name="zip1" size="3" maxlength="3" pattern="^[0-9]+$" style="ime-mode: disabled;">
−<input type="text" class="p-postal-code" id="zip2" name="zip2" size="4" maxlength="4" pattern="^[0-9]+$" style="ime-mode: disabled;">
<br />
ご住所：　
...
<h4>ご希望コース<span class="ak">*</span></h4>
<div id="course">
<div id="oct">
<h5><input type="radio" name="course" value="・10月コース"> 10月コース</h5>
...
<div id="dec">
<h5><input type="radio" name="course" value="・12月コース"> 12月コース</h5>
...
<h4>その他の連絡事項</h4>
<p><textarea id="texts" name="texts" cols="40" rows="5" style="ime-mode: active;" placeholder="託児をご利用の場合は、お子様の人数・年齢を記入してください。（例）人数：２人／５歳・３歳"></textarea></p>
